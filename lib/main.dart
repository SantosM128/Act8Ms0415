...
import 'package:santos0415/ejem1.dart';
import 'package:santos0415/ejem2.dart';
import 'package:santos0415/ejem3.dart';
import 'package:santos0415/ejem4.dart';
import 'package:santos0415/ejem5.dart';
  ...
  Widget MyDrawerList() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          menuItem(1, "Ejemplo 1", Icons.place_outlined,
              currentPage == DrawerSections.ejem1 ? true : false),
          menuItem(2, "Ejemplo 2", Icons.numbers,
              currentPage == DrawerSections.ejem2 ? true : false),
          menuItem(3, "Ejemplo 3", Icons.event,
              currentPage == DrawerSections.ejem3 ? true : false),
          menuItem(4, "Ejemplo 4", Icons.local_hospital_outlined,
